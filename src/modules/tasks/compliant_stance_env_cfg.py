...
class CurriculumCfg:
    ...
    # Stage 5 (4000-5000): kp=350, 0→70N
    force_amplitude = CurrTerm(
        ...
        params={
            ...
            "modify_params": {
                "stages": [(0.0, 70.0), (0.0, 70.0), (0.0, 70.0), (0.0, 70.0), (0.0, 70.0)],
    ...
    stiffness_range = CurrTerm(
        ...
        params={
            ...
            "modify_fn": multi_stage_stiffness,
            "modify_params": {
                "stages": [700.0, 600.0, 500.0, 400.0, 350.0],
                "steps_per_stage": 24000,  # 1000 iters × 24 steps
            },
        },
    )
...
#     stiffness = StiffnessCommandCfg(
#         resampling_time_range=(5.0, 5.0),
#         ranges=StiffnessCommandCfg.Ranges(kp=(30.0, 50.0)), # last working version
...
#         }
#     )
#     # Continuous sinusoidal vertical forces with rest periods (3s ON / 3s OFF)
#     compliance_push = EventTerm(
#         func=apply_sinusoidal_forces_z,
#         mode="interval",
#         interval_range_s=(0.0, 3.0),  # every RL step for smooth force
#         # interval_range_s=(0.02, 0.02),  # every RL step for smooth force
#         params={
#             "asset_cfg": SceneEntityCfg("robot", body_names=["base"]),
...
#     # lin_vel_z_l2 = RewardTerm(func=mdp.lin_vel_z_l2, weight=-0.5)  # reusing l2 pattern; overridden below
#     ang_vel_xy_l2 = RewardTerm(func=mdp.ang_vel_xy_l2, weight=-0.5)  # reusing l2 pattern; overridden below
