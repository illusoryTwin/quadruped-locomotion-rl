...
from src.modules.events import apply_sinusoidal_forces_z, log_env0_compliance
...
class RewardsCfg:
    ...
    ang_vel_xy_l2 = RewardTerm(func=mdp.ang_vel_xy_l2, weight=-0.075)
    ...
    dof_torques = RewardTerm(mdp.joint_torques_l2, weight=-2e-7)
    dof_acc_l2 = RewardTerm(func=mdp.joint_acc_l2, weight=-5e-7)
    action_rate_l2 = RewardTerm(func=mdp.action_rate_l2, weight=-0.2)
...
@configclass
class UnitreeGo2StanceFixedStiffnessEnvCfg(ManagerBasedRLEnvCfg):
